...
public class Line {
	...
	public static void main(String[] args) {
		...
		double lineLength1 = length(vertexX1, vertexY1, vertexX2, vertexY2);
		double lineLength2 = length(vertex2X1, vertex2Y1, vertex2X2, vertex2Y2);
		
		double lineSlope1 = slope(vertexX1, vertexY1, vertexX2, vertexY2);
		double lineSlope2 = slope(vertex2X1, vertex2Y1, vertex2X2, vertex2Y2);
